...
@section('content')
    <div class="container flex-row m-0 p-0">
            ...
            <div class="main ">
                ...
                <div class="coll collapse.show">
                    <a href="#">
                        ...
                        <button class="btn btn-toggle rounded border-0 collapsed " data-bs-toggle="collapse"
                    ...
                    <div class="coll collapse" id="home-collapse">
                        <ul class="ul btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="#"
                                    class="coll-list link-body-emphasis d-inline-flex text-decoration-none rounded">Semua
                                    Status</a></li>
                            <li><a href="#"
                                    class="coll-list link-body-emphasis d-inline-flex text-decoration-none rounded">Reservasi</a>
                            </li>
                            <li><a href="#"
                                    class="coll-list link-body-emphasis d-inline-flex text-decoration-none rounded">Registrasi</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="main-content container d-flex flex-column p-5 p-0"
            style="width: 500px; height: 10px; background-color: #f1f1f1;">
            <div class="d-flex flex-row">
                <nav aria-label="breadcrumb" class="flex-grow-1" style="--bs-breadcrumb-divider: '>';">
                    <ol class="breadcrumb fw-bold " style="">
                        <li class="breadcrumb-item " style="text-decoration: none;"><a href="#"
                                class="text-decoration-none text-black">Rawat Jalan</a></li>
                        <li class="breadcrumb-item active text-black" aria-current="page">Semua Status</li>
                    </ol>
                </nav>
                <button type="button" class="btn btn-primary rounded-0" style="height: 50px" data-bs-container="body"
                    data-bs-toggle="popover" data-bs-placement="left"
                    data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title=""
                    title="">
                    Lihat Panduan
                </button>
            </div>
            ...
            <div class="d-flex flex-row">
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle rounded-0 ms-1"
                        style="width: 250px; background-color: white; color: black;" type="button"
                ...
                <div class="dropdown me-auto">
                    <button class="btn btn-primary dropdown-toggle dropdown-toggle-split rounded-0 ms-1 "
                        style="width: 250px; background-color: white; color: black; " type="button"
                        id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Dokter
                    </button>
            ...
            <div class="d-flex flex-row mb-3">
                ...
                <input type="rumah sakit" class="form-control" id="exampleFormControlInput1"
                    placeholder="Cari MRN, pasien, dokter, kode poli...">
                <input type="user" class="form-control" id="exampleFormControlInput1"
